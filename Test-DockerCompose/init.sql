...
CREATE TABLE IF NOT EXISTS mac_adresses (
    id serial PRIMARY KEY,
...
INSERT INTO mac_adresses (mac, time_stamp) VALUES ('00-1D-60-4A-8C-CB', 1702915589);
INSERT INTO mac_adresses (mac, time_stamp) VALUES ('01-1D-60-4A-8C-CB',  1703174789);

GRANT ALL ON user_credentials TO postgres;
GRANT ALL ON measurements TO postgres;
GRANT ALL ON mac_adresses TO postgres;
